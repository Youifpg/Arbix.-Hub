-- script is open source you can get it but atleast give credit i want help begginers
----------------------------------------------------------------------------------------------------------------------------------------------
...
local Window = Fluent:CreateWindow({
    ...
    SubTitle = "Discord | https://discord.gg/VRHYbyj8Dy",
    TabWidth = 160,
...
local listfastattack = {'Normal Attack','Fast Attack','Extreme Attack'}
	...
	elseif _G.FastAttackDayHub == "Normal Attack" then
		_G.Fast_Delay = 0.12
	elseif _G.FastAttackDayHub == "Extreme Attack" then
		_G.Fast_Delay = 0.02
	end
end)
...
local ToggleCake = Tabs.Main:AddToggle("ToggleCake", {
    ...
    Description = "ออโต้ฟาร์มคาตาคุริ", 
    Default = false })
            ...
            pcall(function()
                if game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince") then
                    ...
                    if game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince") then
                        TP2(game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince").HumanoidRootPart.CFrame * CFrame.new(2,20,2))
                    else
                        if KillMob == 0 then
                        end                    
                        if game:GetService("Workspace").Map.CakeLoaf.BigMirror.Other.Transparency == 1 then
                            if game:GetService("Workspace").Enemies:FindFirstChild("Cookie Crafter") or game:GetService("Workspace").Enemies:FindFirstChild("Cake Guard") or game:GetService("Workspace").Enemies:FindFirstChild("Baking Staff") or game:GetService("Workspace").Enemies:FindFirstChild("Head Baker") then
                                    ...
                                    if v.Name == "Cookie Crafter" or v.Name == "Cake Guard" or v.Name == "Baking Staff" or v.Name == "Head Baker" then
                                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                            repeat task.wait(_G.Fast_Delay)
                                                ...
                                                game:GetService("VirtualUser"):CaptureController()
                                                game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                            until not _G.CakePrince or not v.Parent or v.Humanoid.Health <= 0 or game:GetService("Workspace").Map.CakeLoaf.BigMirror.Other.Transparency == 0 or game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince") or game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince") or KillMob == 0
                                ...
                                MagnetDought = false
                                TP2(CFrame.new(-2091.911865234375, 70.00884246826172, -12142.8359375))
                                if game:GetService("ReplicatedStorage"):FindFirstChild("Cookie Crafter") then
                                    TP2(game:GetService("ReplicatedStorage"):FindFirstChild("Cookie Crafter").HumanoidRootPart.CFrame * CFrame.new(2,20,2)) 
                                else
                                    if game:GetService("ReplicatedStorage"):FindFirstChild("Cake Guard") then
                                        TP2(game:GetService("ReplicatedStorage"):FindFirstChild("Cake Guard").HumanoidRootPart.CFrame * CFrame.new(2,20,2)) 
                                    else
                                        if game:GetService("ReplicatedStorage"):FindFirstChild("Baking Staff") then
                                            TP2(game:GetService("ReplicatedStorage"):FindFirstChild("Baking Staff").HumanoidRootPart.CFrame * CFrame.new(2,20,2))
                                        else
                                            if game:GetService("ReplicatedStorage"):FindFirstChild("Head Baker") then
                                                TP2(game:GetService("ReplicatedStorage"):FindFirstChild("Head Baker").HumanoidRootPart.CFrame * CFrame.new(2,20,2))
                                            end
                                        end
                                    end
                                end                       
                            ...
                            if game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince") then
                                TP2(game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince").HumanoidRootPart.CFrame * CFrame.new(2,20,2))
                            else
                                if game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince") then
                                    TP2(game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince").HumanoidRootPart.CFrame * CFrame.new(2,20,2))
                                end
					...
					if game.ReplicatedStorage:FindFirstChild("Cake Prince") or game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince") then   
                        ...
                        spawn(function()
                            game:GetService("RunService").Heartbeat:Connect(function()
                                pcall(function()
                                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                        if  _G.CakePrince and StartCakeMagnet and (v.Name == "Cookie Crafter" or v.Name == "Cake Guard" or v.Name == "Baking Staff" or v.Name == "Head Baker") and (v.HumanoidRootPart.Position - POSCAKE.Position).magnitude <= 350 then
...
local boss = Tabs.Main:AddSection("Boss Farm")
    ...
    local DropdownMaterial = Tabs.Main:AddDropdown("DropdownMaterial", {
        Title = "Dropdown",
        Description = "เลือกของที่จะฟาร์ม",
        Values = MaterialList,
        Multi = false,
        Default = 1,
    })
    ...
    local ToggleElite = Tabs.Main:AddToggle("ToggleElite", {Title = "Auto Elite Hunter",Description = "ออโต้ตีอีลิตฮันเตอร์", Default = false })
...
if Third_Sea then
	...
	spawn(function()
           ...
           local ToggleYama = Tabs.Main:AddToggle("ToggleYama", {Title = "Auto Get Yama",Description = "ออโต้ดคึงดาบยามะ", Default = false })
        ...
        local ToggleTushita = Tabs.Main:AddToggle("ToggleTushita", {Title = "Auto Tushita",Description = "ออโต้ ทูชิตะ", Default = false })
...
if Second_Sea then
    ...
    if Third_Sea then
        ...
        local ToggleEspKitsune = Tabs.SeaEvent:AddToggle("ToggleEspKitsune", {Title = "Esp Kitsune Island",Description = "", Default = false })
        ...
        local ToggleTPKitsune = Tabs.SeaEvent:AddToggle("ToggleTPKitsune", {Title = "Tween To Kitsune Island",Description = "", Default = false })
        ...
        local ToggleCollectAzure = Tabs.SeaEvent:AddToggle("ToggleCollectAzure", {Title = "Collect Azure Ambers",Description = "", Default = false })
  ...
  if Third_Sea then
    local RoughSea = Tabs.SeaEvent:AddSection("Rough Sea")

    local ToggleSailBoat = Tabs.SeaEvent:AddToggle("ToggleSailBoat", {Title = "Auto buy Boat",Description = "", Default = false })
    ...
    local ToggleTerrorshark = Tabs.SeaEvent:AddToggle("ToggleTerrorshark", {Title = " Kill Terrorshark",Description = "", Default = false })
    ...
    spawn(function()
     ...
     local TogglePiranha = Tabs.SeaEvent:AddToggle("TogglePiranha", {Title = " Kill Piranha",Description = "", Default = false })
     ...
     local ToggleShark = Tabs.SeaEvent:AddToggle("ToggleShark", {Title = " Kill Shark",Description = "", Default = false })
    ...
    local ToggleFishCrew = Tabs.SeaEvent:AddToggle("ToggleFishCrew", {Title = " Kill Fish Crew",Description = "", Default = false })
    ...
    local ToggleShip = Tabs.SeaEvent:AddToggle("ToggleShip", {Title = "Kill Ship",Description = "", Default = false })
...
while wait() do
    ...
    local ToggleGhostShip = Tabs.SeaEvent:AddToggle("ToggleGhostShip", {Title = "Kill Ghost Ship",Description = "",Default = false })
...
local ToggleZ = Tabs.Setting:AddToggle("ToggleZ", {Title = "Skill Z",Description = " Z", Default = true })
ToggleZ:OnChanged(function(Value)
    SkillZ = Value
end)
Options.ToggleZ:SetValue(true)

local ToggleX = Tabs.Setting:AddToggle("ToggleX", {Title = "Skill X", Description = " X",Default = true })
...
local ToggleC = Tabs.Setting:AddToggle("ToggleC", {Title = "Skill C",Description = " C", Default = true })
...
local ToggleV = Tabs.Setting:AddToggle("ToggleV", {Title = "Skill V",Description = " V", Default = true })
...
local ToggleF = Tabs.Setting:AddToggle("ToggleF", {Title = "Skill F",Description = " F", Default = false })
...
--Stats
local ToggleKaitun = Tabs.Stats:AddToggle("ToggleKaitun", {Title = "Auto Kaitun",Description = "", Default = false })
ToggleKaitun:OnChanged(function(Value)
    _G.Auto_Stats_Kaitun = Value
    end)
Options.ToggleKaitun:SetValue(false)
task.spawn(function()
	while wait() do
		pcall(function()
...
local ToggleIsland = Tabs.Teleport:AddToggle("ToggleIsland", {Title = "Teleport Island",Description = "บินไปยังเกาะที่กำหนด", Default = false })
...
local ToggleFruit = Tabs.Fruit:AddToggle("ToggleFruit", {Title = "Buy Fruit Sniper",Description = "ซื้อผลไม้ปีศาจที่เลือกไว้", Default = false })
ToggleFruit:OnChanged(function(Value)
...
local ToggleTweenGear = Tabs.Mirage:AddToggle("ToggleTweenGear", {Title = "Tween To Gear",Description = "", Default = false })
...
local Togglelockmoon = Tabs.Mirage:AddToggle("Togglelockmoon", {Title = "Lock Moon and Use Race Skill",Description = "", Default = false })
...
local ToggleMirage = Tabs.Mirage:AddToggle("ToggleMirage", {Title = "Auto Mirage Island",Description = "", Default = false })
...
local AutoW = Tabs.Mirage:AddToggle("AutoW", {Title = "Auto Press W",Description = "", Default = false })
...
local ToggleAwake = Tabs.Raid:AddToggle("ToggleAwake", {Title = "Auto Awake",Description = "V2", Default = false })
...
local ToggleRandomBone = Tabs.Shop:AddToggle("ToggleRandomBone", {Title = "Auto Random Bone",Description = "/500", Default = false })
...
local ToggleBuyAllAb = Tabs.Shop:AddToggle("ToggleBuyAllAb", {Title = "Auto Buy All Abilitie",Description = "", Default = false })
...
local Jobid = Tabs.Misc:AddSection("Job ID")
Tabs.Misc:AddButton({
	Title = "Copy Job ID",
	Description = "",
	Callback = function()
...
----------------------------------------------------------------------------------------------------------------------------------------------
InterfaceManager:SetFolder("SPEED WAVE FREE")
SaveManager:SetFolder("SPEED/specific-game")
Window:SelectTab(1)
Fluent:Notify({
    Title = "SPEED WAVE | Blox Fruit",
